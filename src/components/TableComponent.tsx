...
const TableComponent: React.FC = () => {
  ...
  return (
    <div className="flex flex-col mt-9 border border-gray-100 rounded bg-zinc-800 text-white">
      {cryptoData ? (
        <table className="table-auto">
          ...
          <tbody>
            {cryptoData.map((data) => (
              <tr
                key={data.id}
                className="text-center text-base border-b border-gray-100  last:border-b-0 hover:bg-zinc-100 hover:text-black"
              >
